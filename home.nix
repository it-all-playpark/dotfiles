...

{
  ...
  programs.fish = {
    ...
    shellInit = ''
      # PATH設定
      fish_add_path ~/.nix-profile/bin /opt/homebrew/bin /opt/homebrew/sbin /usr/bin/php ~/ghq/github.com/astj/ghq-migrator ~/google-cloud-sdk/bin ~/Library/Android/sdk ~/.local/share/mise/shims
