  ...
  programs.yazi = {
    ...
    keymap = {
      manager.keymap = [
        ...
        # Hopping
        { on = "r"; run = "arrow -1"; desc = "Move cursor up"; }
        ...
        { on = "S"; run = "forward"; desc = "Go forward to the next directory"; }
        ...
        # Seeking
        { on = "<C-n>"; run = "seek -5"; desc = "Seek up 5 units in the preview"; }
        { on = "<C-t>"; run = "seek 5"; desc = "Seek down 5 units in the preview"; }
        ...
        { on = "N"; run = "rename --cursor=before_ext"; desc = "Rename selected file(s)"; }
        ...
        { on = "h"; run = "find_arrow"; desc = "Goto the next found"; }
        { on = "H"; run = "find_arrow --previous"; desc = "Goto the previous found"; }
        ...
        # Goto
        { on = [ "g" "t" ]; run = "cd ~/tmp"; desc = "Go to tmp directory"; }
      ...
      spot.keymap = [
        ...
        { on = "n"; run = "arrow -1"; desc = "Move cursor up"; }
        { on = "t"; run = "arrow 1"; desc = "Move cursor down"; }
        { on = "k"; run = "swipe -1"; desc = "Swipe to the next file"; }
        { on = "s"; run = "swipe 1"; desc = "Swipe to the previous file"; }
        { on = "<Up>"; run = "arrow -1"; desc = "Move cursor up"; }
        { on = "<Down>"; run = "arrow 1"; desc = "Move cursor down"; }
      ...
      input.keymap = [
        ...
        { on = "k"; run = "move -1"; desc = "Move back a character"; }
        { on = "s"; run = "move 1"; desc = "Move forward a character"; }
